...
import com.technokratos.common.base.BaseException
        ...
        private fun asRetrofitException(throwable: Throwable): BaseException {
            return when (throwable) {
                is HttpException -> {
                    ...
                    BaseException.httpError(errorCode, resourceManager.getString(com.technokratos.common.R.string.common_error_general_message))
                }
                is IOException -> BaseException.networkError(resourceManager.getString(com.technokratos.common.R.string.common_error_network), throwable)
